This is the list of articles that I have read. Most of the articles are tech-related topic. There are some great lists which we could found from [Dan Liu](https://github.com/danluu). His collection of *post-mortems* and *debuggin-stories* are great.
...
- [A millisecond isn't fast](http://jvns.ca/blog/2015/09/10/a-millisecond-isnt-fast-and-how-we-fixed-it/) Julia Evans wrote an article to summarize her experience to make one function in Scale 100x faster.
...
- [Reverse Engineer Challange](http://challenges.re/): Its title tells all.
- [Stockfighter](https://www.stockfighter.io/) Capture the flag challange
